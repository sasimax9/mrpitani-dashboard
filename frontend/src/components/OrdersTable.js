...
import { Check, X, Download, Search, ChevronLeft, ChevronRight, ArrowUpDown } from 'lucide-react';
          ...
          <>
            <div className="overflow-x-auto">
              <Table>
                ...
                <TableBody>
                  {orders.map((order) => (
                    <TableRow key={order.id} className="border-b border-border hover:bg-muted/30 transition-colors" data-testid={`order-row-${order.id}`}>
